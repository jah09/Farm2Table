...
import { TrendingUp, TrendingDown, Minus, BarChart3, Calendar, Leaf, RefreshCw, DollarSign, Lightbulb, Target, Loader2 } from "lucide-react"
...
export function MarketTrendsDashboard() {
  ...
  // Loading skeleton for trend cards
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-center py-8">
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800">Analyzing Market Trends</h3>
                <p className="text-gray-600">Our AI is processing market data and generating insights...</p>
              </div>
            </div>
          </div>
      ...
      {!isInitialLoading && (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {isLoading ? (
            // Show skeleton cards while refreshing
            Array.from({ length: trends.length || 6 }).map((_, i) => (
              <TrendCardSkeleton key={i} />
            ))
          ) : (
